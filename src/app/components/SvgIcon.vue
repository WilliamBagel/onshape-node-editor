<!--
  ...
  A reusable SVG icon component that renders a <use> reference
  to an SVG sprite symbol by href.
-->
<template>
  <!-- Claude Sonnet 4.6: Inline SVG using <use> to reference sprite symbols -->
  <svg class="svg-icon" :width="size ?? 16" :height="size ?? 16" :aria-label="ariaLabel" :aria-hidden="!ariaLabel"
    focusable="false" style="display: inline-flex; vertical-align: middle;">
    <use :href="href" />
  </svg>
</template>
<style scoped>
.svg-icon {
  /* Inherit the parent's color so icons respond to text-color changes */
  fill: currentColor;
  flex-shrink: 0;
}
</style>
...
/**
 * Props:
 *   href      - The SVG symbol href (e.g. "#svg-icon-build")
 *   size      - Optional pixel size for the icon (default: 16)
 *   ariaLabel - Optional accessible label for the icon
 */
defineProps<{
  href: OnshapeSvgIcon
  size?: number
...
type OnshapeSvgIcon = "#svg-icon-AssemblyReplicate" |
  "#svg-icon-ConeAngleLimit" |
  "#svg-icon-Fix_Icon_Default" |
  "#svg-icon-Fix_Icon_Suppressed" |
  "#svg-icon-Fix_Within_Icon" |
  "#svg-icon-HoverMate" |
  "#svg-icon-Incontext-Import-Linked-Deleted" |
  "#svg-icon-Incontext_Import_Faded" |
  "#svg-icon-Incontext_Import_Linked" |
  "#svg-icon-Incontext_Import_LinkedBroken" |
  "#svg-icon-SnapMate" |
  ...
  "#svg-icon-ball" |
  "#svg-icon-ball_Error" |
  "#svg-icon-ball_External" |
  "#svg-icon-ball_External_Suppressed" |
  "#svg-icon-ball_Suppressed" |
  "#svg-icon-bolt" |
  "#svg-icon-bottom-stack" |
  "#svg-icon-context-update-available" |
  "#svg-icon-create-partstudio-incontext" |
  "#svg-icon-cylindrical" |
  "#svg-icon-cylindrical_Error" |
  "#svg-icon-cylindrical_External" |
  "#svg-icon-cylindrical_External_Suppressed" |
  "#svg-icon-cylindrical_Suppressed" |
  ...
  "#svg-icon-external_overlay" |
  "#svg-icon-fastened-to-origin-inside" |
  "#svg-icon-fastened-to-origin" |
  "#svg-icon-fastened" |
  "#svg-icon-fastened_Error" |
  "#svg-icon-fastened_External" |
  "#svg-icon-fastened_External_Suppressed" |
  "#svg-icon-fastened_Suppressed" |
  "#svg-icon-fastener-autosize" |
  "#svg-icon-fix_icon_External" |
  "#svg-icon-gear" |
  "#svg-icon-gear_Error" |
  "#svg-icon-gear_External" |
  "#svg-icon-gear_External_Suppressed" |
  "#svg-icon-gear_Suppressed" |
  "#svg-icon-generic_mate" |
  "#svg-icon-incontext-active" |
  "#svg-icon-incontext-update-dot" |
  "#svg-icon-insert-item-button" |
  "#svg-icon-linear" |
  "#svg-icon-linear_Error" |
  "#svg-icon-linear_External" |
  "#svg-icon-linear_External_Suppressed" |
  "#svg-icon-linear_Suppressed" |
  "#svg-icon-mate-connector-button" |
  "#svg-icon-mate-connector-button_Error" |
  ...
  "#svg-icon-mateConnector_External" |
  "#svg-icon-mateConnector_External_Suppressed" |
  "#svg-icon-mateConnector_Suppressed" |
  "#svg-icon-mateGroup" |
  "#svg-icon-mateGroup_Error" |
  "#svg-icon-mateGroup_External" |
  "#svg-icon-mateGroup_External_Suppressed" |
  "#svg-icon-mateGroup_Suppressed" |
  "#svg-icon-named-position-button" |
  "#svg-icon-named-view-button" |
  "#svg-icon-nut" |
  "#svg-icon-parallel" |
  "#svg-icon-parallel_Error" |
  "#svg-icon-parallel_External" |
  "#svg-icon-parallel_External_Suppressed" |
  "#svg-icon-parallel_Suppressed" |
  "#svg-icon-pause-dialog" |
  "#svg-icon-pin_slot" |
  "#svg-icon-pin_slot_Error" |
  "#svg-icon-pin_slot_External" |
  "#svg-icon-pin_slot_External_Suppressed" |
  "#svg-icon-pin_slot_Suppressed" |
  "#svg-icon-planar" |
  "#svg-icon-planar_Error" |
  "#svg-icon-planar_External" |
  "#svg-icon-planar_External_Suppressed" |
  "#svg-icon-planar_Suppressed" |
  "#svg-icon-play-dialog" |
  "#svg-icon-rack_and_pinion" |
  "#svg-icon-rack_and_pinion_Error" |
  "#svg-icon-rack_and_pinion_External" |
  "#svg-icon-rack_and_pinion_External_Suppressed" |
  "#svg-icon-rack_and_pinion_Suppressed" |
  "#svg-icon-realign-mate-dialog" |
  "#svg-icon-replace-part" |
  "#svg-icon-revolute" |
  "#svg-icon-revolute_Error" |
  "#svg-icon-revolute_External" |
  "#svg-icon-revolute_External_Suppressed" |
  "#svg-icon-revolute_Suppressed" |
  "#svg-icon-rigid-assembly-configured" |
  "#svg-icon-rigid-assembly" |
  "#svg-icon-rigid-lock" |
  "#svg-icon-rigid-unlock" |
  "#svg-icon-screw" |
  "#svg-icon-screw_Error" |
  "#svg-icon-screw_External" |
  "#svg-icon-screw_External_Suppressed" |
  "#svg-icon-screw_Suppressed" |
  ...
  "#svg-icon-slider" |
  "#svg-icon-slider_Error" |
  "#svg-icon-slider_External" |
  "#svg-icon-slider_External_Suppressed" |
  "#svg-icon-slider_Suppressed" |
  "#svg-icon-standard-content" |
  "#svg-icon-standard-content_Error" |
  "#svg-icon-stop-dialog" |
  "#svg-icon-tangent" |
  "#svg-icon-tangent_Error" |
  "#svg-icon-tangent_External" |
  "#svg-icon-tangent_External_Suppressed" |
  "#svg-icon-tangent_Suppressed" |
  "#svg-icon-top-stack" |
  ...
  "#svg-icon-Insert_column_left" |
  "#svg-icon-Insert_column_right" |
  "#svg-icon-Insert_row_above" |
  "#svg-icon-Insert_row_below" |
  "#svg-icon-Inspection" |
  "#svg-icon-Merge_cells" |
  "#svg-icon-Parenthesis" |
  "#svg-icon-Primary_units_AnglePrecision" |
  "#svg-icon-ProjectedView-Linked" |
  "#svg-icon-Remove_columns" |
  "#svg-icon-Remove_rows" |
  "#svg-icon-SectionView-Linked" |
  "#svg-icon-ShowDimensionUnits" |
  "#svg-icon-Size_column_equally" |
  "#svg-icon-Size_row_equally" |
  "#svg-icon-StandardViews" |
  "#svg-icon-Text_PosHor" |
  "#svg-icon-Tolerance_ToleranceDisplay" |
  "#svg-icon-Tolerance_TolerancePrecision" |
  "#svg-icon-Unmerge_cells" |
  "#svg-icon-addSheet" |
  "#svg-icon-allOver" |
  "#svg-icon-allRound" |
  "#svg-icon-angularity" |
  ...
  "#svg-icon-drawing-angular-dim-3pt" |
  ...
  "#svg-icon-x_b-element" |
  "#svg-icon-x_t-element" |
  ...
  "#svg-icon-box-onshape-favicon-1024" |
  "#svg-icon-box-onshape-favicon-144" |
  "#svg-icon-box-onshape-favicon-150" |
  "#svg-icon-box-onshape-favicon-180" |
  "#svg-icon-box-onshape-favicon-192" |
  "#svg-icon-box-onshape-favicon-256" |
  "#svg-icon-box-onshape-favicon-310-150" |
  "#svg-icon-box-onshape-favicon-310" |
  "#svg-icon-box-onshape-favicon-32" |
  "#svg-icon-box-onshape-favicon-36" |
  "#svg-icon-box-onshape-favicon-48" |
  "#svg-icon-box-onshape-favicon-512" |
  "#svg-icon-box-onshape-favicon-70" |
  "#svg-icon-box-onshape-favicon-72" |
  "#svg-icon-box-onshape-favicon-96" |
  "#svg-icon-box-onshape-favicon" |
  "#svg-icon-box-onshape-gray-green-120" |
  "#svg-icon-box-onshape-gray-green-256" |
  "#svg-icon-box-onshape-gray-green-50" |
  "#svg-icon-box-onshape-gray-green-64" |
  ...
  "#svg-icon-google-drive-icon-48px" |
  "#svg-icon-google-drive-icon-monochrome-48px" |
  ...
  "#svg-icon-okta-logo" |
  "#svg-icon-on-logo" |
  "#svg-icon-on-round-256" |
  "#svg-icon-on-round-64" |
  "#svg-icon-on-round" |
  ...
  "#svg-icon-default-x_b-element" |
  "#svg-icon-default-x_t-element" |
  ...
  "#svg-icon-150715_Sketch_Icons_30_InsertDXFDWG" |
  ...
  "#svg-icon-Fix_Icon_Linked" |
  "#svg-icon-Fix_Icon_Linked_Update" |
  ...
  "#svg-icon-revisioned-document_update" |
  "#svg-icon-selectivemerge-keep-left-15" |
  "#svg-icon-selectivemerge-keep-left-discard-15" |
  "#svg-icon-selectivemerge-keep-left-discard" |
  "#svg-icon-selectivemerge-keep-left" |
  "#svg-icon-selectivemerge-merge-left-15" |
  "#svg-icon-selectivemerge-merge-left" |
  "#svg-icon-selectivemerge-take-left-15" |
  "#svg-icon-selectivemerge-take-left-discard-15" |
